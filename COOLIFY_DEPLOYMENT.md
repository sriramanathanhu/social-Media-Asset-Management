...
```bash
# Authentication - Nandi SSO Only (includes Google login internally)
NANDI_SSO_URL=https://auth.kailasa.ai
NANDI_APP_ID=1243-2739-1026-8361
NANDI_CLIENT_SECRET=qhDHH98ySeYaYWHKJRG2G3QKXZSVKWC5MLT4
...
NEXT_PUBLIC_NANDI_APP_ID=1243-2739-1026-8361
